...
export default function CustomSelect({
  ...
  return (
    <div className={`relative select-none ${className}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute left-0 right-0 top-full mt-2 z-50 rounded-2xl bg-[#ffffff] dark:bg-[#0f172a] border border-slate-200 dark:border-slate-700 shadow-2xl p-1.5 space-y-1 max-h-64 overflow-y-auto custom-scrollbar animate-in fade-in slide-in-from-top-2 duration-150 ring-1 ring-black/5 dark:ring-white/5">
