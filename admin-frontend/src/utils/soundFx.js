/**
 * Synthesized Web Audio UI Sound FX for Creative Computer Academy
 * Works without external MP3 files, 100% lightweight & instantaneous
 */
...
class SoundFX {
  ...
  playSuccess() {
    ...
    try {
      ...
      console.debug('Sound FX error', e);
    }
  }
