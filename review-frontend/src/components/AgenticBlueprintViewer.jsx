            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setCopiedLayerTree(true);
                  setTimeout(() => setCopiedLayerTree(false), 2000);
                }}
              ...
              >
                {copiedLayerTree ? <FiCheck size={12} className="text-emerald-500 dark:text-emerald-400" /> : <FiCopy size={12} />}
                <span>{copiedLayerTree ? 'Copied Tree!' : 'Copy Layer Tree'}</span>
              </button>
            </div>
